...
TEMPERATURE = 0.1
CONTENT_COLS = ["content", "内容"]  # tried in order
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run qwen3-235b CN classifier on a full Excel file.")
    parser.add_argument(
        "--input",
    ...
    try:
        ...
        out_name = f"{input_path.stem}_qwen235b_cn.csv"
